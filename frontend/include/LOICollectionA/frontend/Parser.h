...
namespace LOICollection::frontend {
    class Parser {
        ...
        /* Declarative UI block state: bare statement calls inside `new Form() { ... }`
         * are rewritten as implicit calls on the form being constructed. */
        bool inDeclarativeBlock = false;
        bool declStmtStart = false;
    ...
    private:
        ...
        std::unique_ptr<BlockNode> parseDeclarativeBlock();

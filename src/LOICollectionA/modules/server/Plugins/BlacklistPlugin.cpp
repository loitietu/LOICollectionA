...
#include "LOICollectionA/include/server/Plugins/types/blacklist/BlacklistSchema.h"
...
namespace LOICollection::server::Plugins {
    ...
    std::shared_ptr<BlockRepository> BlacklistPlugin::getDatabase() {
    ...
    ll::Expected<bool> BlacklistPlugin::load() {
        ...
        auto localDb = BlockRepository::open((mDataPath / "blacklist.db").string(), 4);
        if (!localDb)
